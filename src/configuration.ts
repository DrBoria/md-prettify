...
export interface Substitution {
	...
	scope?: string | string[],      // TextMate scope; if specified, the ugly portion's range must be exactly within the given scope
}
...
/** The settings for `mdPrettify.substitutions` */
